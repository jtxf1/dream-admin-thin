...
import { ref } from "vue";
import { useServer } from "./utils/hook";
...
<template>
  <div class="main">
    ...
    >
      <el-form-item label="名称：" prop="blurry">
        <el-input
    ...
    <PureTableBar title="服务器管理列表" :columns="columns" @refresh="onSearch">
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            <el-popconfirm
              :title="`是否确认删除服务器管理名称为${row.name}的这条数据`"
