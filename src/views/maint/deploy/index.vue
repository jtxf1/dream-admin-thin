  ...
  <div class="main">
    ...
    >
      <el-form-item label="应用名称" prop="appName">
        <el-input
          v-model="formQuery.appName"
          placeholder="请输入应用名称"
          clearable
          class="!w-[200px]"
        />
      </el-form-item>
      <el-form-item label="部署时间" prop="createTime">
    ...
    <PureTableBar title="部署管理列表" :columns="columns" @refresh="onSearch">
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            <el-popconfirm
              :title="`是否确认删除部署管理名称为${row.name}的这条数据`"
